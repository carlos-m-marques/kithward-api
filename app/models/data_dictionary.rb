  ...
  Community = self.new([
    ...
    { section: "Activities",
      attrs: [
        ...
        { activity_computers:          { label: "Computers/Internet", data: 'amenity', group_as: "Lifelong learning" }},
        ...
        { activity_lectures:           { label: "Lectures", data: 'amenity', group_as: "ILifelong learning" }},
        { activity_music_classes:      { label: "Music Classes", data: 'amenity', group_as: "Lifelong learning" }},
        { activity_technology_classes: { label: "Technology Classes", data: 'amenity', group_as: "Lifelong learning" }},
