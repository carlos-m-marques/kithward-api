  ...
  Community = self.new([
    ...
    { section: "Staff & Care",
      attrs: [
        ...
        { security_ft_security:    { label: "Full-Time security (24/7)", data: 'flag', group_as: 'Security' }},
    ...
    { section: "Activities",
      attrs: [
        ...
        { activity_poetry:            { label: "Poetry Slams", data: 'amenity', group_as: "Creative" }},
        ...
        { activity_charity:           { label: "Charity/Civic Engagement", data: 'amenity', group_as: "Social & entertainment" }},
        ...
        { activity_live_music:        { label: "Live Music", data: 'amenity', group_as: "Social & entertainment" }},
        ...
        { activity_farmers_market:    { label: "Farmer's Market", data: 'amenity', group_as: "Tripsl" }},
        { activity_historical:        { label: "Historical Attractions", data: 'amenity', group_as: "Trips" }},
        ...
        { activity_shopping:          { label: "Shopping Trips", data: 'amenity', group_as: "Trips" }},
        ...
        { activity_art_classes:        { label: "Art Classes", data: 'amenity', group_as: "Intellectual & educational" }},
    ...
    { section: "Services",
      attrs: [
        ...
        { services_scheduled_transport: { label: "Scheduled Transportation", data: 'amenity', group_as: "Services" }},
    ...
    { section: "Amenitites",
      attrs: [
        ...
        { amenity_chapel:              { label: "Chapel/Place of Worship", data: 'amenity', group_as: "Indoor amenities" }},
