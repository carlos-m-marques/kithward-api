  ...
  Community = self.new([
    ...
    { section: "Staff & Care",
      attrs: [
        ...
        { security_emergency_call:    { label: "Electronic key entry system", data: 'flag', group_as: 'Security' }},
        { security_emergency_call:    { label: "Emergency call system", data: 'flag', group_as: 'Security' }},
        { security_emergency_call:    { label: "Full-Time security (24/7)", data: 'flag', group_as: 'Security' }},
        ...
        { security_emergency_call:    { label: "Regular safety checks", data: 'flag', group_as: 'Security' }},
        { security_inroom_monitoring: { label: "Secure memory unit", data: 'flag', group_as: 'Security' }},
        { security_night_checks:      { label: "Security system", data: 'flag', group_as: 'Security' }},
        { security_emergency_call:    { label: "Staff background checks", data: 'flag', group_as: 'Security' }},
        { security_inroom_monitoring: { label: "Video surveillance", data: 'flag', group_as: 'Security' }},
        { security_night_checks:      { label: "Visitor check-in", data: 'flag', group_as: 'Security' }},
        ...
        { care_mild_cognitive:    { label: "Music therapy", data: 'amenity', group_as: 'Special Care' }},
        ...
        { care_speech:            { label: "Wellness progran", data: 'amenity', group_as: 'Special Care' }},
      ],
    },
