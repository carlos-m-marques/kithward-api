...
{ section: 'pricing',
    ...
    { section: 'accomodations',
      ...
      attrs: [
        ...
        { listings_room_shared:            { label: "Shared room", data: 'amenity', group: 'units', readonly: true, hide: true }},
        { listings_room_private:           { label: "Private room", data: 'amenity', group: 'units', readonly: true, hide: true }},
        { listings_room_companion:         { label: "Shared suite", data: 'amenity', group: 'units', readonly: true, hide: true }},
        { listings_room_studio:            { label: "Studio", data: 'amenity', group: 'units', readonly: true, hide: true }},
        { listings_room_one_bed:           { label: "1 bedroom", data: 'amenity', group: 'units', readonly: true, hide: true }},
        { listings_room_two_plus:          { label: "2 bedrooms +", data: 'amenity', group: 'units', readonly: true, hide: true }},
        { listings_room_detached:          { label: "Detached home", data: 'amenity', group: 'units', readonly: true, hide: true }},
        ...
        { room_companion:         { label: "Shared suite", data: 'amenity', group: 'units', readonly: true, hide: true }},
        { room_studio:            { label: "Studio", data: 'amenity', group: 'units', readonly: true, hide: true }},
        { room_one_bed:           { label: "1 bedroom", data: 'amenity', group: 'units', readonly: true, hide: true }},
        ...
        { room_feat_parking:      { label: "Dedicated parking", data: 'amenity', group: 'features', readonly: true, hide: true }},
        { room_feat_den:          { label: "Den/extra room", data: 'amenity', group: 'features', readonly: true, hide: true }},
        { room_feat_dishwasher:   { label: "Dishwasher", data: 'amenity', group: 'features', readonly: true, hide: true }},
        { room_feat_fireplace:    { label: "Fireplace", data: 'amenity', group: 'features', readonly: true, hide: true }},
        { room_feat_kitchen:      { label: "Full kitchen", data: 'amenity', group: 'features', readonly: true, hide: true }},
        { room_feat_climate:      { label: "Individual climate control", data: 'amenity', group: 'features', readonly: true, hide: true }},
        { room_feat_kitchenette:  { label: "Kitchenette", data: 'amenity', group: 'features', readonly: true, hide: true }},
        { room_feat_pvt_garage:   { label: "Private garage", data: 'amenity', group: 'features', readonly: true, hide: true }},
