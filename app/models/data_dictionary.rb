  ...
  Community = self.new([
    ...
    { section: "Accomodations",
      ...
      attrs: [
        ...
        { room_feat_walkin:       { label: "Walk-in closet", data: 'amenity', group_as: "Unit Features" }},
    ...
    { section: "Care & Support",
      ...
      attrs: [
        ...
        { assistance_bathing:     { label: "Bathing",   data: 'amenity', group_as: 'Day-to-Day Assistance' }},
        { assistance_dressing:    { label: "Dressing",  data: 'amenity', group_as: 'Day-to-Day Assistance' }},
        { assistance_errands:     { label: "Escorts for errands",   data: 'amenity', group_as: 'Day-to-Day Assistance' }},
        { assistance_grooming:    { label: "Grooming",  data: 'amenity', group_as: 'Day-to-Day Assistance' }},
        { assistance_medication:  { label: "Medication management", data: 'amenity', group_as: 'Day-to-Day Assistance' }},
        { assistance_mobility:    { label: "Mobility",  data: 'amenity', group_as: 'Day-to-Day Assistance' }},
        { assistance_toileting:   { label: "Toileting", data: 'amenity', group_as: 'Day-to-Day Assistance' }},
