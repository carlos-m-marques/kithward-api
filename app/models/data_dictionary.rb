class DataDictionary
  ...
  Community = self.new([
    ...
    { section: "Security",
      ...
      attrs: [
        { security_electronic_key:             { label: "Electronic key entry system", data: 'flag' }},
        { security_emergency_pendant:          { label: "Emergency alert pendants", data: 'flag' }},
        { security_ft_security:                { label: "Full-Time Security Staff", data: 'flag' }},
        { security_emergency_call:             { label: "In-room emergency call system", data: 'flag' }},
        { security_night_checks:               { label: "Night checks", data: 'flag' }},
        { security_safety_checks:              { label: "Regular safety checks", data: 'flag' }},
        { security_secure_memory:              { label: "Secure memory unit", data: 'flag' }},
        { security_security_system:            { label: "Security system", data: 'flag' }},
        { security_staff_background_checks:    { label: "Staff background checks", data: 'flag' }},
        { security_video_surveillance:         { label: "Video surveillance", data: 'flag' }},
        { security_visitor_checkins:           { label: "Visitor check-in", data: 'flag' }},
