  ...
  Community = self.new([
    { section: "Community Details",
      attrs: [
        ...
        { aip:    { label: "Aging In Place", data: 'flag', admin_break_after: 'yes'  }},
        ...
        { non_smoking:            { label: "Non-smoking", data: 'flag', admin_break_after: 'yes' }},
    ...
    { section: "Accomodations",
      ...
      attrs: [
        { room_shared:            { label: "Shared room", data: 'amenity', group_as: "Available Units" }},
        { room_private:           { label: "Private room", data: 'amenity', group_as: "Available Units" }},
        { room_studio:            { label: "Studio", data: 'amenity', group_as: "Available Units" }},
        { room_one_bed:           { label: "1 bedroom", data: 'amenity', group_as: "Available Units" }},
        { room_two_plus:          { label: "2 bedrooms +", data: 'amenity', group_as: "Available Units" }},
        { room_dettached:         { label: "Detached home", data: 'amenity', group_as: "Available Units" }},

        { room_feat_bathtub:      { label: "Bathtub", data: 'amenity', group_as: "Unit Features" }},
        { room_feat_custom:       { label: "Custom renovations available", data: 'amenity', group_as: "Unit Features" }},
        { room_feat_den:          { label: "Den/extra room", data: 'amenity', group_as: "Unit Features" }},
        { room_feat_kitchen:      { label: "Full kitchen", data: 'amenity', group_as: "Unit Features" }},
        { room_feat_kitchenette:  { label: "Kitchenette", data: 'amenity', group_as: "Unit Features" }},
        { room_feat_dishwasher:   { label: "Dishwasher", data: 'amenity', group_as: "Unit Features" }},
        { room_feat_climate:      { label: "Individual climate control", data: 'amenity', group_as: "Unit Features" }},
        { room_feat_pvt_outdoor:  { label: "Private outdoor space", data: 'amenity', group_as: "Unit Features" }},
        { room_feat_walkin:       { label: "Walk-in closets", data: 'amenity', group_as: "Unit Features" }},
        { room_feat_washer:       { label: "Washer/dryer", data: 'amenity', group_as: "Unit Features" }},

        { room_floorplans:        { label: "Floor Plans", data: 'ignore', special: 'thumbnails', tagged_as: 'floorplan'}},
      ],
    },
    ...
    { section: "Care & Support",
      ...
      attrs: [
        ...
        { assistance_errands:     { label: "Escorts for errands",   data: 'amenity', group_as: 'Personal Assistance' }},
    ...
    { section: "Amenities",
      ...
      attrs: [
        ...
        { amenity_ping_pong:             { label: "Ping pong table", data: 'amenity', group_as: "Racquet Sports" }},
