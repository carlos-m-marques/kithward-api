...
{ section: 'pricing',
    ...
    { section: 'accomodations',
      ...
      attrs: [
        ...
        { listing_room_shared:            { label: "Shared room", data: 'amenity', group: 'units', readonly: true, hide: true }},
        { listing_room_private:           { label: "Private room", data: 'amenity', group: 'units', readonly: true, hide: true }},
        { listing_room_companion:         { label: "Shared suite", data: 'amenity', group: 'units', readonly: true, hide: true }},
        { listing_room_studio:            { label: "Studio", data: 'amenity', group: 'units', readonly: true, hide: true }},
        { listing_room_one_bed:           { label: "1 bedroom", data: 'amenity', group: 'units', readonly: true, hide: true }},
        { listing_room_two_plus:          { label: "2 bedrooms +", data: 'amenity', group: 'units', readonly: true, hide: true }},
        { listing_room_detached:          { label: "Detached home", data: 'amenity', group: 'units', readonly: true, hide: true }},
