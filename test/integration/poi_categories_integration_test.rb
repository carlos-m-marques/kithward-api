...
class PoiCategoriesIntegrationTest < ActionDispatch::IntegrationTest
  ...
  test "anyone can retrieve specific POIs" do
    get "/v1/poi_categories/#{@coffee.id}"
    assert_response :success
  ...
  test "only admin users can create POI categories" do
    post "/v1/poi_categories", params: {name: "Restaurant"}
    assert_response 401 # unauthorized

    post "/v1/poi_categories", params: {name: "Restaurant", access_token: @token}
    assert_response 401 # unauthorized

    post "/v1/poi_categories", params: {name: "Restaurant", access_token: @admin_token}
    assert_response :success
